...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<table id='multi-image' class="table table-bordered table-striped datatable">
				<thead>
					<tr>
						<th>ID</th>
						<th>Title</th>
				...
				<a href="<?php echo base_url('Admin/Configuration/create'); ?>"><button class="btn btn-default">Create New Configuration</button></a>
