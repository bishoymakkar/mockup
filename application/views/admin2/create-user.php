...
<div class="col-md-12">
	...
	<div class="panel-body">
						...
						<form role="form" class="form-horizontal form-groups-bordered" method="post" action="<?php echo base_url();?>Admin/Users/createUser"  enctype="multipart/form-data">
							...
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-5">
									<input type="submit" class="btn btn-default" name="add" value="Add User">
								</div>
							</div>
...
<div class="c"></div>
				...
				<a href="<?php echo base_url('Admin/Styles'); ?>"><button class="btn btn-default">Create Style for this user</button></a>
