...
<div class="login-container">
	...
	<div class="login-form">
		...
		<div class="login-content">
			...
			<form method="post" role="form" id="form_login" action="<?php echo base_url('Admin/Login/') ?>">
				...
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input type="text" class="form-control" name="admin_email" id="admin_email" placeholder="Username" autocomplete="off" />
					</div>
