...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
		...
		<?php $tab="styles"; require 'sidebar_header.php'; ?>
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="panel-body">
					...
					<form role="form" class="form-horizontal form-groups-bordered" method="post" action="<?php echo base_url();?>admin/styles/create_style"  enctype="multipart/form-data">
						...
						<div class="form-group">
							<div class="col-sm-offset-3 col-sm-5">
								<input type="submit" class="btn btn-primary" name="add" value="Create Style">
							</div>
						</div>
