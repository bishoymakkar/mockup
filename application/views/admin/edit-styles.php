...
<?php echo base_url();?>admin/styles/edit/{id}"  enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-dm-5">
                                <img src="<?php echo base_url(); ?>public/img/styles/{img}" width="250">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-5">
                                <input type="submit" class="btn btn-primary" name="add" value="Edit Style">
                            </div>
                        </div>
