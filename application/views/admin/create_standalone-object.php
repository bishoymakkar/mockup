...
<div class="page-container">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <form role="form" class="form-horizontal form-groups-bordered" method="post" action="<?php echo base_url();?>admin/objects/create_standalone"  enctype="multipart/form-data">
